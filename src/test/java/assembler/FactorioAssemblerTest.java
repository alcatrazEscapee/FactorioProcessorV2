...
class FactorioAssemblerTest
{
    ...
    void testKeyboard()
    {
        ...
        test("assets/test_keyboard.s", 32861, 36974, 36877, 24669, 27758, 27917, 19460, 17381, 20483, 32784);
    }
    ...
    void testInputOutput()
    {
        ...
        test("assets/test_input_output.s", 57421, 64622, 65533, 24605, 27758, 27789, 32861, 36974, 36877, 1280, 24653, 27758, 27661, 37001, 448, 1504, 24605, 27758, 27885, 32861, 36974, 36877, 864, 24653, 27758, 27661, 37001, 704, 32784, 65513, 31747, 39955, 41053, 46190, 46349, 49321, 21508, 17381, 22613, 19459, 20483, 27673, 36889, 901, 27673, 3075, 31748, 39956, 64553, 16, 65513, 31763, 39971, 19460, 20483, 27673, 36889, 19460, 17334, 31764, 39972, 64553, 16, 16477, 18542, 18445, 41225, 2051, 47097, 18457, 41927, 16, 78, 65, 77, 69, 63, 0, 72, 69, 76, 76, 79, 44, 0);
    }
